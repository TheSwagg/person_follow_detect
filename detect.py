...
if __name__ == '__main__':
    ...
    # 检测图片的文件夹路径
    parser.add_argument('--source', type=str, default='data/videos/Armor_5.mp4', help='source')  # file/folder, 0 for webcam
    ...
    # 是否显示结果 (当需要显示出来时需要在Edit Configuration --> Parameters中填入--view-img才可以imshow出图像)
